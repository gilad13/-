...
# checking if more than 80 precent of a message are words in english
...
def checking_parameters(message, key):
    ...
    there shouldn't be digits duplications, the key shouldn't be longer than 7), the key cannot be 1, the message must be filled
    ...
    if len(str(key)) > 7:
        return False, "Key must be at most 7 digits long."
